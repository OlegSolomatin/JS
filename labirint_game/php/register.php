    ...
    if(isset($_POST["btn_submit_register"]) && !empty($_POST["btn_submit_register"])){
        ...
        if(isset($_POST["captcha"]) && !empty($captcha)){
            ...
            if(($_SESSION["rand"] != $captcha) && ($_SESSION["rand"] != "")){
                ...
                ("HTTP/1.1 301 Moved Permanently");//ISPRAVLENO
                ("Location: ".$address_site."/index.php");//ISPRAVLENO
            ...
            if(isset($_POST["first_name"])){
                ...
                if(!empty($first_name)){
                    ...
                    //Возвращаем пользователя на страницу регистрации
                    ("HTTP/1.1 301 Moved Permanently");//ISPRAVLENO
                    ("Location: ".$address_site."/index.php");//ISPRAVLENO//ISPRAVLENO
                    //Останавливаем скрипт
                    exit();
                }
            ...
            if(isset($_POST["email"])){
                ...
                ("Location: ".$address_site."/index.php");
                //Останавливаем  скрипт
                exit();
            }
